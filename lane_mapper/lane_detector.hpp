...
class LaneDetector {
 public:
   ...
   */
  void ExtractLaneFeaturesFrontCamera(const oimage::OImagePtrVector& input_oimages,
   ...
   */
  void ApplyMatchedFilterFrontCamera(const cv::Mat& input_mat, const math::Plane& ground_plane,
